<?php
    ...
    class Bd {
        ...
        public function getClientesTotais() {
            $query = 'select count(*) as clientes_totais from tb_clientes';
            $stmt = $this->conexao->prepare($query);
            $stmt->execute();

            return $stmt->fetch(PDO::FETCH_OBJ)->clientes_totais;
        }
    }
    ...
    $dashboard->__set('clientesTotais', $bd->getClientesTotais());
